...
map/cin/cout gave TLE, so used vector/scanf/printf
https://www.codechef.com/viewsolution/46500302
*/
...
bool check(ll totalCooks) {
	...
	// not needed since all dishes are over
	// while(c<C) {
		// adding more chefs along journey
	// }
